...
def run_perft_tests():
    print("-------------------------------- Test 1 --------------------------------")
    run_perft_test('rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1 ', 3, [20, 400, 8902, 197281, 4865609])
    print("-------------------------------- Test 2 --------------------------------")
    run_perft_test('rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8 ', 3, [44, 1486, 62379, 2103487, 89941194])
    print("-------------------------------- Test 3 --------------------------------")
    run_perft_test('r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10 ', 3, [46, 2079, 89890, 3894594, 164075551])
